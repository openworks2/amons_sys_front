...
const getMonitorReducer = handleAsyncActions(GET_MONITOR, "monitor", true);

const getScannerReducer = handleAsyncActions(GET_SCANNER, "scanner", true);

const getBleBeaconReducer = handleAsyncActions(GET_SCANNER, "beacon", true);

const getWeatherReducer = handleAsyncActions(GET_WEATHER, "weather", true);
