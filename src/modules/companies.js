...
import { createPromiseThunk, handleAsyncActions, handleAsyncActionsById, reducerUtils, createPromiseThunkOfPost, handleAsyncActionsOfPost, createPromiseThunkOfPut, handleAsyncActionsOfPut } from '../lib/asyncUtils';
...
export const getCompanies = createPromiseThunk(GET_COMPANIES, companiesAPI.getCompanies);
export const getCompany = createPromiseThunk(GET_COMPANY, companiesAPI.getCompanyById);
export const postCompany = createPromiseThunkOfPost(POST_COMPANY, companiesAPI.postCompany);
export const putCompany = createPromiseThunkOfPut(PUT_COMPANY, companiesAPI.putCompany);
...
const getCompaniesReducer = handleAsyncActions(GET_COMPANIES, 'companies', true);
const getCompanyReducer = handleAsyncActionsById(GET_COMPANY, 'company', true);
const postCompanyReducer = handleAsyncActionsOfPost(POST_COMPANY, 'companies', true);
const putCompanyReducer = handleAsyncActionsOfPut(PUT_COMPANY, 'companies', true);
