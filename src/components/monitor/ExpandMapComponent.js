...
const ExpandMapComponent = ({ setOpenExpandMapHandler }) => {
    ...
    return (
        <ExpandMapCompo className="expand-map-component">
            ...
            <div className="compress-button-box buttom-box" onClick={setOpenExpandMapHandler}>
                <FontAwesomeIcon icon={faCompress} />
            </div>
            <div className="map-area">
                <img src="../../map/expand_entrance.png" alt="입구" className="entrance-image" id="entrance001" />
                {
                    rendering(517, 63, dig1)
                }
                <img src="../../map/expand_entrance.png" alt="입구" className="entrance-image" id="entrance002" />
                <img src="../../map/expand_entrance.png" alt="입구" className="entrance-image" id="entrance003" />
                {
                    rendering(645, 293, dig2)
                }
                <img src="../../map/expand_entrance.png" alt="입구" className="entrance-image" id="entrance004" />
