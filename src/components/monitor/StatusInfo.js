  ...
  return (
    <StatusInfoCompo className="statusInfo-component">
      ...
      <div className="status-box">
        ...
        <div className="bottom-contents">
          <div className="bottom-left">
            <p className="icon worker-icon">
              <FontAwesomeIcon icon={faUserHardHat} />
            </p>
          </div>
          <div className="bottom-right">
            <p className="count-box worker-count">
              <span className="value" id="worker-value">
                {bleCount.worker < 10 ? `0${bleCount.worker}` : bleCount.worker}
              </span>
              <span className="unit" id="worker-unit">
                명
              </span>
            </p>
          </div>
      ...
      <div className="status-box">
        ...
        <div className="bottom-contents">
          <div className="bottom-left">
            <p className="icon vehicle-icon">
              <FontAwesomeIcon icon={faTruck} />
            </p>
          </div>
          <div className="bottom-right">
            <p className="count-box vehicle-count">
              <span className="value" id="vehicle-value">
                {bleCount.vehicle < 10
                  ? `0${bleCount.vehicle}`
                  : bleCount.vehicle}
              </span>
              <span className="unit" id="vehicle-unit">
                대
              </span>
            </p>
          </div>
      ...
      <div className="status-box">
        ...
        <div className="bottom-contents progress-bottom">
          <div className="bottom-left">
            <p className="icon progress-icon">
          ...
          <div className="bottom-right progress-bottom-right">
            <p className="count-box progress-info-top">
              ...
              <span className="unit" id="progress-unit">
                %
              </span>
            </p>
            <p className="progress-info-bottom">
              <span className="progress-current-value">
                {drillStatus.drill}
              </span>
              /
