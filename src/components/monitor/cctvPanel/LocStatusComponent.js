  ...
  return (
    <LocStatusCompo className="location-status-component">
      ...
      <div className="state-box worker-box">
        <div className="contents-box">
          <p className="title-icon worker-icon">
            <FontAwesomeIcon icon={faUserHardHat} />
          </p>
          <span className="current-value worker-value">
      ...
      <div className="state-box vehicle-box">
        <div className="contents-box">
          <p className="title-icon vehicle-icon">
            <FontAwesomeIcon icon={faTruck} />
          </p>
          <span className="current-value vehicle-value">
            {bleCount.vehicle < 10 ? `0${bleCount.vehicle}` : bleCount.vehicle}
          </span>
          &nbsp;
      ...
      <div className="state-box progress-box">
        <div className="contents-box">
          <p className="title-icon progress-icon">
