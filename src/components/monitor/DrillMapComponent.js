    ...
    <DrillMapCompo className="drillMap-component">
      <div className="location-top">
        ...
        <div className="location-distance top-distance">
          {`함양 L=${numberOfDigitsHandler(
            data[0].plan_length + data[1].plan_length
          )}m`}
        </div>
      ...
      <div className="location-bottom">
        ...
        <div className="location-distance bottom-distance">
          {`울산 L=${numberOfDigitsHandler(
            data[2].plan_length + data[3].plan_length
          )}m`}
        </div>
      ...
      {ratePanelOpen && (
        <DrillRatePanel
          data={data}
          numberOfDigitsHandler={numberOfDigitsHandler}
        />
      )}
    </DrillMapCompo>
  );
